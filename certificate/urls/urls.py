...
urlpatterns = [
    ...
    path('approved-certificates/', admin_view.ApprovedCertificatesList.as_view(), name='approved_certificates'),
    path('approved-certificate/', user_view.ApprovedCer.as_view(), name='approved_cer'),
