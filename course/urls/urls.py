...
urlpatterns = [
    ...
    path('edit-award-category/<int:pk>/', admin_views.AwardCategoryUpdateView.as_view(), name='edit_award_category'),
    path('delete-award-category/<int:pk>/', admin_views.AwardCategoryDeleteView.as_view(), name='delete_award_category'),
