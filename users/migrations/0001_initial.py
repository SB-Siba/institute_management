    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roll_number', models.CharField(default='ROLL0001', max_length=20)),
                ...
                ('course_fees', models.FloatField(blank=True, default=0.0, null=True)),
                ('discount_rate', models.FloatField(blank=True, default=0.0, null=True)),
                ('discount_type', models.CharField(blank=True, choices=[('amount+', 'Amount +'), ('amount-', 'Amount -'), ('percent+', 'Percent +'), ('percent-', 'Percent -')], default='amount-', max_length=10)),
                ('discount_amount', models.FloatField(blank=True, default=0.0, null=True)),
                ('total_fees', models.FloatField(blank=True, default=0.0, null=True)),
